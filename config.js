...
global.sudo = process.env.SUDO || '967774318278'
global.devs = '967735038560';
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? '𝑨𝑴𝑹𝑶 𝑲𝑯𝑨𝑳𝑰𝑫 👑' : process.env.OWNER_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '𝑨𝑴𝑹𝑶 𝑲𝑯𝑨𝑳𝑰𝑫 👑' : process.env.PACK_INFO.split(";")[1],
